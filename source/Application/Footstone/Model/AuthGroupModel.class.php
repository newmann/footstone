...
class AuthGroupModel extends Model {
    ...
    protected $_validate = array(
        array('fcode','require', '必须设置角色代码', Model::MUST_VALIDATE ),
        array('fcode', '1,20', -1, Mdel::EXISTS_VALIDATE, 'length'), //角色代码长度不合法
        array('fcode', '', -3, Model::EXISTS_VALIDATE, 'unique'), //角色代码被占用
        
        array('fname','require', '必须设置角色名称', Model::MUST_VALIDATE ),
        array('fname', '1,100', -1, Mdel::EXISTS_VALIDATE, 'length'), //角色名称长度不合法
        array('fname', '', -3, Model::EXISTS_VALIDATE, 'unique'), //角色名称被占用

        //array('title','require', '必须设置用户组标题', Model::EXISTS_VALIDATE  ,'regex',Model::MODEL_INSERT),
        array('fdescription','0,500', '描述最多500字符', Model::VALUE_VALIDATE , 'length'  ,Model::MODEL_BOTH ),
    ...
    protected $_auto = array(
        ...
        // array('', 'get_client_ip', self::MODEL_INSERT, 'function', 1),
        array('fupdatetime', NOW_TIME),
